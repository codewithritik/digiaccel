...
import { AdminLoginFunction, AdminRegistration } from "../../../Redux/action";
...
export const AdminLogin = () => {
    ...
    const handleSubmit = (event) => {
      ...
      if (form.checkValidity() === false){
        ...
        dispatch(AdminLoginFunction(formValue, setCookie, navigate));
        }
      ...
      <SignupCont>
        ...
        <div className="RightContanier">
          <div>
            ...
            >
              Not Registered User?{" "}
              <Link to="/register">Click here to Registered</Link>
            </p>
          </div>
        </div>
      </SignupCont>
