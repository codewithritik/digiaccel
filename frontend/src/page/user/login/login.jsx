...
import { UserLoginFuction, UserRegistration } from "../../../Redux/action";
    ...
    const handleSubmit = (event) => {
      ...
      if (form.checkValidity() === false){
        ...
        setValidated(true);
            ...
            dispatch(
              UserLoginFuction(formValue, setCookie, navigate, uniqueId)
            );
      ...
      <SignupCont>
        ...
        <div className="RightContanier">
          <div>
            ...
            >
              Already Registered User? <Link to={`/user_register/${uniqueId}`}>Click here to login</Link>
            </p>
          </div>
        </div>
      </SignupCont>
